...
// Usar la página actual como fallback si no hay return_url
$redirect_url = $_POST['return_url'] ?? ($_SERVER['HTTP_REFERER'] ?? '/nexusplay/cart.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['juego_id']) && !isset($_POST['update_quantity']) && !isset($_POST['remove_from_cart']) && !isset($_POST['clear_cart'])) {
        ...
        if ($user_id) {
            ...
            updateCartCount(); // ⚠️ Solo actualizar contador para invitados
        }
