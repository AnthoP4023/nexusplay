    ...
    <div class="transacciones-container">
        ...
        <div class="transacciones-table-container">
                ...
                <tbody>
                    <?php foreach($transacciones as $t): ?>
                        <tr>
                            ...
                            <td><span class="badge badge-<?php echo $t['tipo']; ?>"><?php echo ucfirst($t['tipo']); ?></span></td>
                            <td class="amount <?php echo $t['tipo']; ?>">$<?php echo number_format($t['monto'],2); ?></td>
            ...
            <div class="pagination">
                <?php $params = $_GET; ?>
                <a href="?<?php echo http_build_query(array_merge($params,['pagina'=>1])); ?>" class="btn-page"><i class="fas fa-angle-double-left"></i></a>
                <a href="?<?php echo http_build_query(array_merge($params,['pagina'=>max(1,$pagina_actual-1)])); ?>" class="btn-page"><i class="fas fa-angle-left"></i></a>
                <span class="page-info">Página <?php echo $pagina_actual; ?> de <?php echo $total_paginas; ?></span>
                <a href="?<?php echo http_build_query(array_merge($params,['pagina'=>min($total_paginas,$pagina_actual+1)])); ?>" class="btn-page"><i class="fas fa-angle-right"></i></a>
                <a href="?<?php echo http_build_query(array_merge($params,['pagina'=>$total_paginas])); ?>" class="btn-page"><i class="fas fa-angle-double-right"></i></a>
            </div>
        </div>
    </div>
</main>
