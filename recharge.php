        ...
        <div class="recharge-container">
            ...
            <div class="recharge-content">
                ...
                <form method="POST" class="recharge-form">
                    ...
                    <div class="custom-amount-input" id="customAmountDiv" style="display: none;">
                        ...
                        <input type="number" id="custom_amount" name="custom_amount" 
                               min="1" max="1000" step="0.01" placeholder="Ingresa el monto">
                    </div>
                    ...
                    <div class="recharge-summary">
                        <div class="summary-row">
                            ...
                            <span>$<?php echo number_format($saldo_cartera, 2); ?></span>
                        </div>
                        <div class="summary-row">
                        ...
                        <div class="summary-row total">
                            ...
                            <span id="new-balance">$<?php echo number_format($saldo_cartera, 2); ?></span>
                        </div>
                    </div>
                ...
                <div class="recharge-info">
                    ...
                    <ul>
                        <li>Los fondos se acreditarán inmediatamente a tu cartera</li>
                        <li>Puedes usar tu cartera para comprar cualquier juego en NexusPlay</li>
                        <li>Tus datos de tarjeta están protegidos con cifrado de nivel bancario</li>
                        <li>Monto mínimo de recarga: $1.00</li>
                        <li>Monto máximo de recarga: $1,000.00</li>
                    </ul>
                </div>
            </div>
        </div>
